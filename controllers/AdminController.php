...
class AdminController {
    ...
    public function showAdmin() : void
    {
        ...
        $commentManager = new CommentManager(); // Assure-toi de passer $this->db si nécessaire
        $nbComments = [];

        foreach ($articles as $article) {
            $nbComments[$article->getId()] = $commentManager->countCommentsByArticleId($article->getId());
       ...
       usort($articles, function($a, $b) use ($sort, $order, $nbComments) {
            ...
            elseif ($sort === 'comments') {
                $result = ($nbComments[$a->getId()] ?? 0) <=> ($nbComments[$b->getId()] ?? 0);
            }
